...
local JustLogAllTests = true -- Rather than stopping at a failed test, run all tests and log the output to script-output folder. No pausing will ever occur between tests if enabled, even for failures. Results written to a text file in: script-output/RailwayTunnel_Tests.txt
...
local TestsToRun = {
    ...
    PlayerRidingSmoothMovementTests = {enabled = true, testScript = require("tests/player-riding-smooth-movement-tests")},
    -- Code Internal tests:
