...
TunnelShared.HighlightValidPlacementPositionsOnRailGrid = function(placer, position, surface, entityName, ghostName, direction)
    local highlightAudiencePlayer, highlightAudienceForce = EventUtils.GetPlayerOrForceFromEventActioner(placer)
...
TunnelShared.EntityErrorMessage = function(entityDoingInteraction, text, surface, position)
    local textAudiencePlayer, textAudienceForce = EventUtils.GetPlayerOrForceFromEventActioner(entityDoingInteraction)
    rendering.draw_text {
        text = text,
        surface = surface,
        target = position,
