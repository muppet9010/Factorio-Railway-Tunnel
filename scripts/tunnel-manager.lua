...
Tunnel.RemoveTunnel = function(tunnel)
    ...
    -- TODO: this list isn't populated as we bulk clone, but we also don't want to delete rails. In the future we want to reuse them for future tunnels. We could use the on_entity_cloned event to track rails being cloned if we really needed to populate it.
