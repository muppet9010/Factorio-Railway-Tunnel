...
local SpecificTrackShapesFilter = {} -- Pass in an array of TrackShapes keys to do just those. Leave as nil or empty table for all. Only used when DoSpecificTests is TRUE.
