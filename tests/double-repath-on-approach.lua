...
Test.Start = function(testName)
    local _, placedEntitiesByType = TestFunctions.BuildBlueprintFromString(blueprintString, {x = 50, y = 60}, testName)
    ...
    local repathTrain = placedEntitiesByType["locomotive"][1].train
