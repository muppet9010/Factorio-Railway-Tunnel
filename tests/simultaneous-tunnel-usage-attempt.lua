...
Test.EveryTick = function(event)
    ...
    if testDataBespoke.stoppedAlertsStartedTick == nil and (testDataBespoke.headingWestTrain.speed == 0 or testDataBespoke.headingEastTrain.speed == 0) then
        ...
        local westPlayerAlerts = TableUtils.TableMergeCopies({westPlayerAlertsCarriage1, westPlayerAlertsCarriage2})
        ...
        local eastPlayerAlerts = TableUtils.TableMergeCopies({eastPlayerAlertsCarriage1, eastPlayerAlertsCarriage2})
