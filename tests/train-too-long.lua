-- Sends a long train at a short portal tunnel. Should be stopped with the loco at the entrance portal entry point. After it sits there for 5 seconds it then moves away from the tunnel. Confirms the alerts appear and then vanish as expected.
